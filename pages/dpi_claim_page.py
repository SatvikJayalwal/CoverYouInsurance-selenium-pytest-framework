...
class DPIClaimPage:
    ...
    def fill_lawyer_details(self):
        ...
        # Select Lawyer
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//select[@name='dpi_laywer_id']")))
        Select(self.wait.until(EC.presence_of_element_located((By.XPATH, "//select[@name='dpi_laywer_id']")))).select_by_index(1)

        # Select Appointment Type
        Select(self.wait.until(EC.presence_of_element_located((By.XPATH, "//select[@id='dpi_laywer_appointmnet_type_id']")))).select_by_index(1)
        ...
        self.wait.until(EC.invisibility_of_element((By.XPATH, "//select[@name='dpi_laywer_id']")))
        ...
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//input[@id='dpi_assesment_invoice_amt_id']"))).send_keys("50000")
        self.driver.find_element(By.XPATH, "//input[@id='dpi_assesment_actual_amt_id']").send_keys("45000")
        self.driver.find_element(By.XPATH, "//input[@id='dpi_assesment_reserve_amt_id']").send_keys("40000")
        self.driver.find_element(By.XPATH, "//input[@id='dpi_assesment_approved_amt_id']").send_keys("35000")
        self.driver.find_element(By.XPATH, "//input[@id='dpi_assesment_deductible_amt_id']").send_keys("1000")
        self.driver.find_element(By.XPATH, "//input[@id='dpi_assesment_defence_cost_id']").send_keys("2000")
        ...
        #wait for the form to dissapear
        self.wait.until(EC.invisibility_of_element((By.XPATH, "//input[@id='dpi_assesment_invoice_amt_id']")))

        # --- Form 3: Add Hearing ---
        safe_click(self.driver, lambda d: self.wait.until(
            EC.element_to_be_clickable((By.XPATH, "//a[@class='form-submit-btn mb-0 float-right'][contains(text(),'Add')]"))
        ))
    ...
    def fill_insurance_company_details(self):
        ...
        # Fill form fields
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//input[@id='dpi_insurence_company_name_id']"))).send_keys("New India Assurance")
        self.driver.find_element(By.XPATH, "//input[@id='dpi_insurence_mobile_id']").send_keys("9999988888")
        self.driver.find_element(By.XPATH, "//input[@id='dpi_insurence_email_id']").send_keys("nia@email.com")
        ...
        #wait for the form to dissapear
        self.wait.until(EC.invisibility_of_element((By.XPATH, "//input[@id='dpi_loss_date_id']")))
    ...
    def fill_case_details(self):
        ...
        # 1. Date of Loss
        date_of_loss = self.wait.until(EC.presence_of_element_located((By.XPATH, "//input[@id='dpi_loss_date_id']")))
        ...
        Select(self.wait.until(EC.presence_of_element_located((By.XPATH, "//select[@name='dpi_loss_cause_id']")))).select_by_visible_text("Death")
        Select(self.wait.until(EC.presence_of_element_located((By.XPATH, "//select[@name='dpi_notice_type_id']")))).select_by_visible_text("Legal Notice")

        # 3. Date of Notice Received
        notice_date = self.wait.until(EC.presence_of_element_located((By.XPATH, "//input[@id='dpi_date_of_notice_recieved_id']")))
        ...
        # 4. Loss Description
        self.driver.find_element(By.XPATH, "//textarea[@id='dpi_loss_desc_id']").send_keys("Vehicle severely damaged in accident.")

        # 5. Loss Estimate
        self.driver.find_element(By.XPATH, "//textarea[@id='dpi_loss_eastimate_id']").send_keys("150000")
